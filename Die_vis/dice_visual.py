...
def main(number_of_rolls=5000) -> None:
    ...
    # Visiualization of results.
    x_values = list(range(2, max_result + 1))
    data = [Bar(x=x_values, y=frequencies)]

    x_axis_config = {'title': 'Результат суммы 2х 6ти гранных кубиков', 'dtick': 1}
    y_axis_config = {'title': 'Частота'}
    my_layout = Layout(title=f'Результаты броска 2х 6ти гранных кубиков {number_of_rolls} раз',
